...
class RadialExpansionDemo extends StatelessWidget {
  ...
  static Widget _buildPage(BuildContext context, String imageName, String description, Animation<double> animation) {
    return Container(
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'assets/images/beachball-alpha.png', 'Chair'),
          ],
        ),
      ),
    );
